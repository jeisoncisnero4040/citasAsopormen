...
class DateManager {
    ...
    public static function getIndexDayByDayList(array $list){
        return collect($list)->map(fn($day) =>self::$daysWeekInverted[$day] )->toArray();
    }
    ...
    public static function getYears(string $date): int
    {
        return Carbon::parse($date)->age;
    }
    public static function getMonths(string $date): int
    {
