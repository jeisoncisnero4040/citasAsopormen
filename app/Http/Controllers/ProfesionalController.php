...
class ProfesionalController extends Controller
{
     ...
     * )
     */
    public function getAllProfesionalByStringSearch(Request $request)
    {
    ...
    public function getCalendarProByCCinRangeTime(Request $request){
        $calendar=$this->profesionalService->getCalendarPro($request->query());
        return response()->json($calendar,200);

    }
    public function getProfesionalsProcedims(Request $request):JsonResponse{
        return response()->json(
            data:$this->profesionalService->getProcediprosByProCedula($request->query()),
            status:200
    ...
    public function getSchedule(Request $request){
        return response()->json(
            data:$this->profesionalService->getScheduleByCedula($request->query()),
            status:200
