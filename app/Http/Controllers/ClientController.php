...
class ClientController extends Controller{
    ...
    public function __construct(ClientService $clientService,ResponseManager $responseManager)
    {
     ...
     * )
     */
    public function getAllClientByStringSearch(Request $request){
        $dto=GetClientDto::fromArray($request->query());
        $clients=$this->clientService->searchClient(dto:$dto);
    ...
    {
        $response=$this->clientService->getDataClientByHistoryId($request->all());
    ...
    public function getAuthorizationByClientCode(Request $request){
        $clientCode=$request->query('codigo');
    ...
    public function Update(string $codigo,Request $requets){
        $dto= new UpdateUserDto($requets->all());
        $response=$this->clientService->updateClient(dto:$dto,codigo:$codigo);
    ...
    public function getCalendarClientByCodInRangeTime(Request $request){
        $calendar=$this->clientService->getCalendarClient($request->query());
        return response()->json($calendar,200);

    }

    public function getFullInfoClient(Request $request){
        $data=$request->query();
        $response=$this->clientService->getFullInfoClient(request:$data);
    ...
    public function getUtility(){
        return response()->json(
            data:$this->clientService->getUtilitiesUser(),
            status:200
                );
    }
