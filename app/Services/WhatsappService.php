...
use Carbon\Carbon;
use App\Ports\FakeApiCitasPort;
use App\Ports\CitasPort;
 

class WhatsappService implements Sendeable  {
    private $responseManager;
    private $twilioService;
    private FakeApiCitasPort $apiCitasAsopormenService;
    private CitasPort $citasService;
    ...
    public function __construct(ResponseManager $responseManager, TwilioService $twilioService,
                                FakeApiCitasPort $apiCitasAsopormenService,
                                CitasPort $citasService)
    {
