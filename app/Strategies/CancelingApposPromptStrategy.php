...
class CancelingApposPromptStrategy implements PromptFactoryStrategy
{
    public function supports(Chat $chat): bool
    {
        return $chat->getStatus() === ChatStatusEnum::CANCELING_APPOINTMENTS;
    }
    ...
    public function build(Chat $chat): Prompt
    {
        ...
        return PromptBuilder::fromChat($chat)
            ...
            ->withRole('system')
            ->withStream(PromptConfig::CANCELING_APPOINTMENTS)
            ->build();
    }
}