...
class OrdersCaseValidator {
    public static function validateNewCase(array $newCase) {
        ...
        $validator= Validator::make($newCase, [
            ...
            'url_imagen_cedula1' => 'required|url|max:200',
            'url_imagen_cedula2' => 'required|url|max:200',
            'url_imagen_order' => 'nullable|url|max:200',
            'url_imagen_historia_1' => 'nullable|url|max:200',
            'url_imagen_historia_2' => 'nullable|url|max:200',
            'url_imagen_historia_3' => 'nullable|url|max:200',
            'url_imagen_historia_4' => 'nullable|url|max:200',
            'url_imagen_historia_5' => 'nullable|url|max:200',
            'url_imagen_preautoriz' => 'nullable|url|max:200',
            'url_imagen_autoriz' => 'nullable|url|max:200',
            'url_case_in_pdf' => 'nullable|url|max:200',
