...
Route::delete('/chats', [ChatsController::class, 'dropAllChats']);


Route::post('/webhook', [ChatsController::class, 'receiveMessage']);

Route::get('/ia/test', [IaController::class, 'executeTest']);